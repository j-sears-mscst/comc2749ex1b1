...
namespace Christoc.Modules.jsearsEx1b1PurchaseOrder
{
    ...
    /// 
    /// Because the control inherits from jsearsEx1b1PurchaseOrderSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : jsearsEx1b1PurchaseOrderModuleSettingsBase
    {
