...
namespace Christoc.Modules.jsearsEx1b1PurchaseOrder.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.jsearsEx1b1PurchaseOrder.Data.SqlDataprovider,jsearsEx1b1PurchaseOrder";
